<template>
  <div class="grid grid-cols-1 md:grid-cols-2">
    ...
    <div class="flex flex-col items-center">
      <img src="~/public/images/portrait.jpg" alt="portrait" class="ml-3 w-9/12 h-auto rotate-6 rounded-xl">
      <ul class="flex flex-col w-9/12 mt-10 font-medium text-sm gap-2">
      ...
      <div class="flex w-9/12 mt-10 font-medium text-sm border-t border-gray-300 dark:border-gray-700">
