<template>
  <div class="flex w-full flex-col">
    <div class="flex flex-col w-7/12 items-start">
      ...
      <p class="mt-8 text-gray-400 text-base font-normal leading-7 text-left">
      ...
      <div class="w-full grid grid-cols-1 gap-3 border-l border-gray-200">
        <div v-for="article in data" :key="article._id">
          <div class="flex flex-row w-full h-auto">
            ...
            <div class="flex flex-col w-3/5 items-start justify-start gap-3 p-5 rounded-xl hover:bg-neutral-800 duration-500 cursor-pointer">
